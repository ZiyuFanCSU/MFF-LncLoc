...
def CTD(seq):
    ...
    for i in range(tmp):
        if seq[i] == "A":
            ...
            if a == 1:
                A0_dis = ((i * 1.0) + 1) / n
            if a == int(round_up(num_A / 4.0)):
                A1_dis = ((i * 1.0) + 1) / n
            if a == int(round_up(num_A / 2.0)):
                A2_dis = ((i * 1.0) + 1) / n
            if a == int(round_up((num_A * 3 / 4.0))):
                A3_dis = ((i * 1.0) + 1) / n
            if a == num_A:
                A4_dis = ((i * 1.0) + 1) / n
        if seq[i] == "T":
            ...
            if t == 1:
                T0_dis = ((i * 1.0) + 1) / n
            if t == int(round_up(num_T / 4.0)):
                T1_dis = ((i * 1.0) + 1) / n
            if t == int(round_up((num_T / 2.0))):
                T2_dis = ((i * 1.0) + 1) / n
            if t == int(round_up((num_T * 3 / 4.0))):
                T3_dis = ((i * 1.0) + 1) / n
            if t == num_T:
                T4_dis = ((i * 1.0) + 1) / n
        if seq[i] == "G":
            ...
            if g == 1:
                G0_dis = ((i * 1.0) + 1) / n
            if g == int(round_up(num_G / 4.0)):
                G1_dis = ((i * 1.0) + 1) / n
            if g == int(round_up(num_G / 2.0)):
                G2_dis = ((i * 1.0) + 1) / n
            if g == int(round_up(num_G * 3 / 4.0)):
                G3_dis = ((i * 1.0) + 1) / n
            if g == num_G:
                G4_dis = ((i * 1.0) + 1) / n
        if seq[i] == "C":
            ...
            if c == 1:
                C0_dis = ((i * 1.0) + 1) / n
            if c == int(round_up(num_C / 4.0)):
                C1_dis = ((i * 1.0) + 1) / n
            if c == int(round_up(num_C / 2.0)):
                C2_dis = ((i * 1.0) + 1) / n
            if c == int(round_up(num_C * 3 / 4.0)):
                C3_dis = ((i * 1.0) + 1) / n
            if c == num_C:
                C4_dis = ((i * 1.0) + 1) / n
    return (
